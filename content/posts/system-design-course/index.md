...
![how-dns-works](images/how-dns-works.jpg)
...
![dns-query-types](images/Iterative-and-recursive-dns-query-diagram.jpg)
...
![redundant-load-balancing](images/redundant-load-balancer.jpg)
...
![active-passive](images/active-passive.jpg)
...
![global-cache](images/global-cache.jpg)
...
![forward-proxy](images/forward-proxy.jpg)
...
![database-types](images/database-types.jpg)
...
![master-slave-replication](images/master-slave-replication.jpg)
...
![master-master-replication](images/master-master-replication.jpg)
...
![dense-index](images/dense-index.jpg)
...
![sparse-index](images/sparse-index.jpg)
...
CAP theorem states that a distributed system can deliver only two of the three desired characteristics Consistency, Availability, and Partition tolerance (CAP).
 <p align="center">
    <img src="images/cap-theorem-key-65.jpg" alt="CPA">
 </p>
...
NoSQL databases are great for distributed networks. They allow for **horizontal scaling**, and they can quickly scale across multiple nodes. When deciding which NoSQL database to use, it’s important to keep the CAP theorem in mind. NoSQL databases can be classified based on the two CAP features they support.
 ...
 <p align="center">
    <img src="images/cap_theorem-system-design-samirpaul1.jpg" alt="cap-theorem">
 </p>
...
![pacelc-theorem](images/pacelc-theorem.jpg)
...
![transaction-states](images/transaction-states.jpg)
...
![two-phase-commit](images/two-phase-commit.jpg)
...
![three-phase-commit](images/three-phase-commit.jpg)
...
![simple-hashing](images/simple-hashing.jpg)
...
![consistent-hashing](images/consistent-hashing.jpg)
...
![virtual-nodes](images/virtual-nodes.jpg)
...
![database-federation](images/database-federation.jpg)
...
![message-queue](images/message-queue.jpg)
...
![publish-subscribe](images/publish-subscribe.jpg)
...
![enterprise-service-bus](images/enterprise-service-bus.jpg)
...
![architecture-range](images/architecture-range.jpg)
...
![event-sourcing](images/event-sourcing.jpg)
...
![command-and-query-responsibility-segregation](images/command-and-query-responsibility-segregation.jpg)
...
![backend-for-frontend](images/backend-for-frontend.jpg)
...
![long-polling](images/long-polling.jpg)
...
![websockets](images/websockets.jpg)
...
![server-sent-events](images/server-sent-events.jpg)
...
![geohashing](images/geohashing.jpg)
...
![quadtree-subdivision](images/quadtree-subdivision.jpg)
...
![rate-limiting](images/rate-limiting.jpg)
...
![client-side-service-discovery](images/client-side-service-discovery.jpg)
...
![server-side-service-discovery](images/server-side-service-discovery.jpg)
...
![virtualization-vs-containerization](images/virtualization-vs-containerization.jpg)
...
![url-shortener-datamodel](images/url-shortener-datamodel.jpg)
...
![url-shortener-basic-design](images/url-shortener-basic-design.jpg)
...
![url-shortener-advanced-design](images/url-shortener-advanced-design.jpg)
...
![whatsapp-datamodel](images/whatsapp-datamodel.jpg)
...
![whatsapp-basic-design](images/whatsapp-basic-design.jpg)
...
![whatsapp-advanced-design](images/whatsapp-advanced-design.jpg)
...
![twitter-datamodel](images/twitter-datamodel.jpg)
...
![newsfeed-pull-model](images/newsfeed-pull-model.jpg)
...
![newsfeed-push-model](images/newsfeed-push-model.jpg)
...
![twitter-advanced-design](images/twitter-advanced-design.jpg)
...
![netflix-datamodel](images/netflix-datamodel.jpg)
...
![video-processing-pipeline](images/video-processing-pipeline.jpg)
...
![file-chunking](images/file-chunking.jpg)
...
![netflix-advanced-design](images/netflix-advanced-design.jpg)
...
![uber-datamodel](images/uber-datamodel.jpg)
...
![uber-working](images/uber-working.jpg)
...
![uber-advanced-design](images/uber-advanced-design.jpg)
